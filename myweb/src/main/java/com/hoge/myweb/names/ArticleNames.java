...
public class ArticleNames {
     ...
     * boardIdのプロパティ名を返します。
     * 
     * @return boardIdのプロパティ名
     */
    public static PropertyName<Integer> boardId() {
        return new PropertyName<Integer>("boardId");
    }
    ...
    public static _BoardNames board() {
        return new _BoardNames("board");
    }

    /**
     * commentsのプロパティ名を返します。
     * 
     * @return commentsのプロパティ名
     */
    public static _CommentNames comments() {
        return new _CommentNames("comments");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _ArticleNames extends PropertyName<Article> {

        /**
         * インスタンスを構築します。
         */
        public _ArticleNames() {
        }
         ...
         *            名前
         */
        public _ArticleNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ArticleNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return boardIdのプロパティ名
         */
        public PropertyName<Integer> boardId() {
            return new PropertyName<Integer>(this, "boardId");
        }
         ...
         * @return boardのプロパティ名
         */
        public _BoardNames board() {
            return new _BoardNames(this, "board");
        }
         ...
         * @return commentsのプロパティ名
         */
        public _CommentNames comments() {
            return new _CommentNames(this, "comments");
        }
