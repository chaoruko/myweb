...
/**
 * {@link BoardCluster}のプロパティ名の集合です。
 * 
 */
...
public class BoardClusterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _BoardClusterNames extends PropertyName<BoardCluster> {

        /**
         * インスタンスを構築します。
         */
        public _BoardClusterNames() {
        }
         ...
         *            名前
         */
        public _BoardClusterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _BoardClusterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
